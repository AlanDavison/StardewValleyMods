...
namespace DecidedlyShared.Utilities
{
    public class Drawing
    {
        ...
        public static void DrawStringWithShadow(SpriteBatch spriteBatch, SpriteFont font, string text, Vector2 position, Color textColour, Color shadowColour, int xOffset = 2, int yOffset = 2)
        {
            // Draw the shadow...
