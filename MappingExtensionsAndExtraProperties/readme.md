...
| **2.5.0**  | [Closeup interaction (trigger action)](docs/trigger-actions.md#Closeup-interaction-trigger-actions)         | N/A       | You can now use MEEP's closeup interactions with trigger actions. Meaning, with SpaceCore's help, you can add closeup interactions to *items*.                                                                                                                                                                                                                                                      |
